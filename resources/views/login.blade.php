                ...
                <div class="col-sm-12">
                    ...
                    <form id="form">
                        ...
                        <div class="text-center">
                            {{-- <img src="assets/images/logo.png" alt="logo.png" style="width:60%"> --}}
                        </div>
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <p class="text-danger field_error" id="email_error"></p>
                                    <label class="float-label">Your Email/Username</label>
                                </div>
                                <div class="form-group form-primary">
                                    <input type="password" name="password" class="form-control">
                                    <p class="text-danger field_error" id="password_error"></p>
